...
int Validator::cleanCut(OsiRowCut &aCut, const double *solCut, const OsiSolverInterface &si, const CglParam &par,
...
int Validator::cleanCut2(OsiRowCut &aCut, const double *solCut, const OsiSolverInterface &si, const CglParam & /* par */,
  const double *origColLower, const double *origColUpper)
{
  /** Compute fill-in in si */
  int numcols = si.getNumCols();
